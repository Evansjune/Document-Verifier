...
import 'package:doc_verify/JsonModels/users.dart';
import 'package:doc_verify/SQLite/sqlite.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const ListTile(
                    title: Center(
                      child: Text(
                        "Create Account",
                        style:
                            TextStyle(fontSize: 30, fontWeight: FontWeight.bold,color: Color(0xFF65B0B4),),
                      ),
                    ),
                  ),
                  ...
                  // we check whether password matches or not
                  Container(
                    margin: const EdgeInsets.all(8),
                    padding:
                        const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
